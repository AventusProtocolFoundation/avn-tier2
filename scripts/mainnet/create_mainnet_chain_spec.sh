...
eth_accounts_file="${release_dir}/ethereum-keys-mainnet.json"
eth_events_file="${release_dir}/ethereum-events-mainnet.json"
...
command="${avn_tier2_dir}/scripts/generate-chain-spec.sh -c avnMainnet --staging --mainnet \
