...
mod test_set_publish_root_contract {
    ...
    impl Context {
        fn dispatch_set_publish_root_contract(&self) -> DispatchResult {
            return EthereumTransactions::set_publish_root_contract(self.origin.clone(), self.new_contract_address.clone());
        }
    }
    ...
    mod successful_cases {
        ...
        fn update_publish_root_contract() {
            ...
            ext.execute_with(||{
                ...
                assert_eq!(context.new_contract_address, EthereumTransactions::get_publish_root_contract());
            });
        }
    }
    ...
    mod fails_when {
        ...
        fn zero_contract_should_fail() {
            ...
            ext.execute_with(||{
                ...
                assert_noop!(context.dispatch_set_publish_root_contract(), Error::<TestRuntime>::InvalidContractAddress);
                assert_ne!(context.new_contract_address, EthereumTransactions::get_publish_root_contract());
            });
        }
