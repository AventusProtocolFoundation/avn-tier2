    ...
    mod succeeds_when {
        ...
        fn call_targets_a_whitelisted_pallet() {
            ...
            ext.execute_with(|| {
                ...
                assert_ok!(AvnProxy::proxy(Origin::signed(context.relayer.account_id()), inner_call, None));
    ...
    mod fails_when {
        ...
        fn origin_is_unsigned() {
            ...
            ext.execute_with(||{
                ...
                assert_noop!(
                    AvnProxy::proxy(unsigned_origin, inner_call, None),
                    BadOrigin
                );
            });
        }
        ...
        fn call_is_not_allowed_to_be_proxied() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(
                    AvnProxy::proxy(Origin::signed(context.relayer.account_id()), invalid_inner_call, None),
        ...
        fn inner_call_fails_to_execute() {
            ...
            ext.execute_with(|| {
                ...
                let inner_call_with_duplicate_external_ref = create_signed_mint_single_nft_call(&context);

                assert_noop!(
                    AvnProxy::proxy(Origin::signed(context.relayer.account_id()), inner_call_with_duplicate_external_ref, None),
