...
mod process_event {
    ...
    struct Context {
        ...
        pub check_result: EthEventCheckResult<<mock::TestRuntime as frame_system::Config>::BlockNumber,AccountId>,
    ...
    impl Default for Context {
        fn default() -> Self {
            ...
            Context{
                ...
                signature: TestSignature(0, vec![]), // TODO [TYPE: test][PRI: high][JIRA: 348]: Replace this with a valid signature
    ...
    impl Context {
        pub fn custom_event_check_result(min_challenge_votes: u32, check_result: CheckResult) -> Self {
            ...
            mod and_event_is_executed_successfully {
                ...
                fn logs_ethereum_event_rejected() {
                    ...
                    ext.execute_with(||{
                        ...
                        let event = mock::Event::pallet_ethereum_events(
                            crate::Event::<TestRuntime>::EventRejected(
                                context.event_id,
                ...
                fn logs_offence_reported() {
                    ...
                    ext.execute_with(||{
                        ...
                        let event = mock::Event::pallet_ethereum_events(
                            crate::Event::<TestRuntime>::OffenceReported(
                                EthereumLogOffenceType::IncorrectValidationResultSubmitted,
                                vec![(context.checked_by, context.checked_by)],
                        ));
                        assert_eq!(true, an_event_was_emitted(&event));
                    });
                }
                    ...
                    ext.execute_with(||{
                        ...
                        assert_eq!(offences, vec![(
                            ...
                            InvalidEthereumLogOffence {
                                ...
                                offenders: vec![
                                    (context.validator.account_id, context.validator.account_id)
                                ],
            ...
            mod and_event_is_executed_successfully {
                ...
                fn logs_ethereum_event_accepted() {
                    ...
                    ext.execute_with(||{
                        ...
                        let event = mock::Event::pallet_ethereum_events(crate::Event::<TestRuntime>::EventAccepted(context.event_id));
                        assert_eq!(true, an_event_was_emitted(&event));
                    });
                }
            ...
            mod and_event_is_not_executed_successfully {
                ...
                fn removes_event_from_pending_list() {
                    ...
                    ext.execute_with(||{
                        ...
                        assert_err!(call_process_event_result(&context), Error::<TestRuntime>::InvalidEventToProcess);
                        assert_eq!(true, there_are_no_pending_events());
                    });
                }
                ...
                fn logs_ethereum_event_processed() {
                    ...
                    ext.execute_with(||{
                        ...
                        let accepted_event = mock::Event::pallet_ethereum_events(crate::Event::<TestRuntime>::EventAccepted(context.event_id));
    ...
    fn setup_preconditions(context: &Context) {
        <EventsPendingChallenge<TestRuntime>>::append((context.check_result.clone(), DEFAULT_INGRESS_COUNTER, 0));
        ...
        assert!(!<ProcessedEvents>::contains_key(&context.event_id));
    }
    ...
    fn add_challenge(context: &Context) {
        ...
        let _ = <Challenges<TestRuntime>>::insert(context.event_id.clone(), vec![
    ...
    fn event_is_in_processed_list(context: &Context) -> bool {
        return <ProcessedEvents>::contains_key(&context.event_id);
    }
