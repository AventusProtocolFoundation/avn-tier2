...
mod test_set_event_challenge_period {
    ...
    impl Default for Context {
        fn default() -> Self {
            Context {
                ...
                new_event_challenge_period: 1200
            }
        }
    }
    ...
    impl Context {
        fn dispatch_set_event_challenge_period(&self) -> DispatchResult {
            return EthereumEvents::set_event_challenge_period(self.origin.clone(), self.new_event_challenge_period.clone());
        }

        fn event_challenge_period_updated_emitted(&self) -> bool {
            return System::events().iter().any(|a| a.event
                == mock::Event::pallet_ethereum_events(crate::Event::<TestRuntime>::EventChallengePeriodUpdated(
                    self.new_event_challenge_period
                )));
        }
    }
    ...
    mod success_implies {
        ...
        fn event_challenge_period_is_updated() {
            ...
            ext.execute_with(||{
                ...
                assert_ne!(context.new_event_challenge_period, EthereumEvents::event_challenge_period());

                assert_ok!(context.dispatch_set_event_challenge_period());

                assert_eq!(context.new_event_challenge_period, EthereumEvents::event_challenge_period());
            });
        }
    ...
    mod fails_when {
        ...
        fn event_challenge_perid_is_invalid() {
            ...
            ext.execute_with(||{
                ...
                assert_noop!(context.dispatch_set_event_challenge_period(), Error::<TestRuntime>::InvalidEventChallengePeriod);
