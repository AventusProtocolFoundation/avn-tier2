...
mod proxy_signed_bond {
    ...
    impl BondContext {
        ...
        fn create_call_for_bond_approved_by_relayer(&self, sender_nonce: u64) -> Box<<TestRuntime as Config>::Call> {
    ...
    mod fails_when {
        ...
        fn sender_does_not_have_enough_fund() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(context.origin.clone(), bond_call, None), Error::<TestRuntime>::InsufficientBond);
            });
        }
        ...
        fn bond_call_is_unauthorized() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(context.origin.clone(), bond_call, None), Error::<TestRuntime>::UnauthorizedSignedBondTransaction);
            });
        }
    }
}