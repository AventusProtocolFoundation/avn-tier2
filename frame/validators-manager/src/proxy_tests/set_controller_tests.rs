...
mod proxy_signed_set_controller {
    ...
    impl SetControllerContext {
        ...
        fn create_call_for_set_controller(&self, sender_nonce: u64) -> Box<<TestRuntime as Config>::Call> {
        ...
        fn create_call_for_set_controller_approved_by_relayer(&self, sender_nonce: u64) -> Box<<TestRuntime as Config>::Call> {
        ...
        fn create_proof_for_signed_set_controller(&self, sender_nonce: u64) -> Proof<Signature, AccountId> {
    ...
    fn succeeds_with_good_parameters() {
        ...
        ext.execute_with(|| {
            ...
            assert!(pallet_staking::Ledger::<TestRuntime>::contains_key(&new_controller_account_id));
    ...
    mod fails_when {
        ...
        fn extrinsic_is_unsigned() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(RawOrigin::None.into(), set_controller_call, None), BadOrigin);
            });
        }
        ...
        fn set_controller_call_is_unauthorized() {
            ...
            ext.execute_with(|| {
                ...
                let set_controller_call = context.create_call_for_set_controller_approved_by_relayer(nonce);

                assert_noop!(AvnProxy::proxy(context.origin.clone(), set_controller_call, None), Error::<TestRuntime>::UnauthorizedSignedSetControllerTransaction);
            });
        }
    }
}