...
mod proxy_signed_set_payee {
    ...
    impl SetPayeeContext {
        ...
        fn create_call_for_set_payee(&self, sender_nonce: u64) -> Box<<TestRuntime as Config>::Call> {
        ...
        fn create_call_for_set_payee_approved_by_relayer(&self, sender_nonce: u64) -> Box<<TestRuntime as Config>::Call> {
        ...
        fn create_proof_for_signed_set_payee(&self, sender_nonce: u64) -> Proof<Signature, AccountId> {
    ...
    fn succeeds_with_good_parameters() {
        ...
        ext.execute_with(|| {
            ...
            assert_eq!(Staking::payee(stash_account_id), RewardDestination::Account(*new_payee_account_id));
    ...
    mod fails_when {
        ...
        fn extrinsic_is_unsigned() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(RawOrigin::None.into(), set_payee_call, None), BadOrigin);

                // The RewardDestination is not set to a payee account
                assert_ne!(Staking::payee(stash_account_id), RewardDestination::Account(*new_payee_account_id));
            });
        }
        ...
        fn set_payee_call_is_unauthorized() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(context.origin.clone(), set_payee_call, None), Error::<TestRuntime>::UnauthorizedSignedSetPayeeTransaction);
