...
use sp_runtime::{assert_eq_error_rate, Perbill, DispatchError::BadOrigin};
    ...
    mod fails_when {
        ...
        fn extrinsic_is_unsigned() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(RawOrigin::None.into(), nominate_call, None), BadOrigin);
            });
        }
        ...
        fn sender_is_not_controller_account() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(context.origin.clone(), nominate_call, None), Error::<TestRuntime>::NotController);
            });
        }
        ...
        fn sender_does_not_have_enough_fund() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(context.origin.clone(), nominate_call, None), Error::<TestRuntime>::InsufficientFundsToNominateBond);
            });
        }
        ...
        fn sender_is_already_a_validator() {
            ...
            ext.execute_with(|| {
                ...
                assert_noop!(AvnProxy::proxy(context.origin.clone(), nominate_call, None), Error::<TestRuntime>::AlreadyValidating);
            });
        }
    }
}
