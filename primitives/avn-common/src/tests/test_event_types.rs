...
fn test_lifted_avt_parse_bytes_good_case() {
    ...
    let expected_receiver_address = H256(hex!("1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e"));
...
fn test_added_validator_parse_bytes_good_case() {
    ...
    let expected_t2_address = H256(hex!("1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e1e"));
...
fn test_added_validator_parse_bytes_too_many_topics() {
    ...
    let data = Some(c.data);
    let topics = vec![c.topic1.clone(), c.topic2.clone(), c.topic1.clone(), c.topic3.clone(), c.topic3.clone()];
    let result = AddedValidatorData::parse_bytes(data, topics);
