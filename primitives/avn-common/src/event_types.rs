...
const DISCARDED_ZERO_BYTES : usize = 12; // the first bytes of an Ethereum address are 0
...
impl ValidEvents {
    pub fn signature(&self) -> H256 {
        match *self {
            ...
            ValidEvents::AddedValidator => H256(hex!("ff083a6e395a67771f3c9108922bc274c27b38b48c210b0f6a8c5f4710c0494b")),

            // hex string of Keccak-256 for LogLifted(address,address,bytes32,uint256)
            ValidEvents::Lifted => H256(hex!("8964776336bc2fa8ecaaf70b6f8e8450807efb1ff78f8b87980707aa821f0ec0")),

            // hex string of Keccak-256 for AvnMintTo(uint256,uint64,bytes32,string)
            ValidEvents::NftMint => H256(hex!("242e8a2c5335295f6294a23543699a458e6d5ed7a5839f93cc420116e0a31f99")),

            // hex string of Keccak-256 for AvnTransferTo(uint256,bytes32,uint64)
            ValidEvents::NftTransferTo => H256(hex!("fff226ba128aca9718a568817388f3711cfeedd8c81cec4d02dcefc50f3c67bb")),

            // hex string of Keccak-256 for AvnCancelNftListing(uint256,uint64)
            ValidEvents::NftCancelListing => H256(hex!("eb0a71ca01b1505be834cafcd54b651d77eafd1ca915d21c0898575bcab53358")),

            // hex string of Keccak-256 for AvnEndBatchListing(uint256)
            ValidEvents::NftEndBatchListing => H256(hex!("20c46236a16e176bc83a795b3a64ad94e5db8bc92afc8cc6d3fd4a3864211f8f")),
        }
    }
...
impl AddedValidatorData {
    ...
    pub fn is_valid(&self) -> bool {
        return !self.eth_public_key.is_zero() && !self.t2_address.is_zero() && !self.validator_account_id.is_zero();
    }
    ...
    pub fn parse_bytes(data: Option<Vec<u8>>, topics: Vec<Vec<u8>>) -> Result<Self, Error> {
        ...
        if data.len() != WORD_LENGTH {
            // TODO [TYPE: refactoring][PRI: low]: replace this by an Error enumeration
...
impl LiftedData {
    ...
    pub fn parse_bytes(data: Option<Vec<u8>>, topics: Vec<Vec<u8>>) -> Result<Self, Error> {
        ...
        let token_contract = H160::from_slice(&topics[Self::TOPIC_CURRENCY_CONTRACT][DISCARDED_ZERO_BYTES..WORD_LENGTH]);
        let sender_address = H160::from_slice(&topics[Self::TOPIC_INDEX_T1_ADDRESS][DISCARDED_ZERO_BYTES..WORD_LENGTH]);
        ...
        let amount = u128::from_be_bytes(data[HALF_WORD_LENGTH..WORD_LENGTH].try_into().expect("Slice is the correct size"));
...
impl NftMintData {
    ...
    pub fn is_valid(&self) -> bool {
        return !self.batch_id.is_zero() && !self.t2_owner_public_key.is_zero() && self.unique_external_ref.len() > 0;
    }
    ...
    pub fn parse_bytes(data: Option<Vec<u8>>, topics: Vec<Vec<u8>>) -> Result<Self, Error> {
        ...
        return Ok(NftMintData {
            batch_id,
            t2_owner_public_key,
            op_id: 0u64, // deprecated
            t1_contract_issuer: H160::zero(), // deprecated
            sale_index,
...
impl NftTransferToData {
    ...
    pub fn parse_bytes(data: Option<Vec<u8>>, topics: Vec<Vec<u8>>) -> Result<Self, Error> {
        ...
        let t2_transfer_to_public_key = H256::from_slice(&topics[Self::TOPIC_INDEX_T2_TRANSFER_TO_PUBLIC_KEY]);
...
impl NftCancelListingData {
    ...
    pub fn parse_bytes(data: Option<Vec<u8>>, topics: Vec<Vec<u8>>) -> Result<Self, Error> {
        ...
        return Ok(NftCancelListingData {
            nft_id,
            op_id,
        });
    }
...
impl NftEndBatchListingData {
    ...
    pub fn parse_bytes(data: Option<Vec<u8>>, topics: Vec<Vec<u8>>) -> Result<Self, Error> {
        ...
        return Ok(NftEndBatchListingData {
            batch_id,
        });
    }
}
...
impl Default for EventData {
    fn default() -> Self { EventData::EmptyEvent }
}
...
impl Default for CheckResult {
    fn default() -> Self { CheckResult::Unknown }
}
...
impl<AccountId: Member> Challenge<AccountId> {
    pub fn new(event_id: EthEventId, challenge_reason: ChallengeReason, challenged_by: AccountId) -> Self
    {
...
impl Default for ChallengeReason {
    fn default() -> Self { ChallengeReason::Unknown }
}
...
impl<AuthorityId: Member, AccountId: Member> Validator<AuthorityId, AccountId> {
    ...
    {
        return Validator::<AuthorityId, AccountId> {
